...
public class PatientPlan extends javax.swing.JDialog {
    ...
    public PatientPlan(String id, java.awt.Frame parent, boolean modal) {   
        super(parent, modal);
        initComponents();
        ...
        SubTable.setTableHeader(tblPatientPlan, new Color(240, 240, 240), Color.BLACK, new Font("Tahoma", Font.PLAIN, 12));
        
        sd = new ShowDataToTable("SELECT P.Name, P.Description \n" +
                                "FROM Patient Pt INNER JOIN [Transaction] T \n" +
                                "ON Pt.Ssn = T.[Patient.Ssn] INNER JOIN [Plan] P \n" +
                                "ON P.ID = T.[Plan.ID]\n" +
                                "WHERE Pt.Ssn = '" + ID + "'", tblPatientPlan, 2);
    }
    ...
    private void initComponents() {
        ...
        tblPatientPlan = new javax.swing.JTable();
        ...
        lblHealthcarePro.setText("Healthcare Plans List");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204), 2));

        tblPatientPlan.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        tblPatientPlan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblPatientPlan.setRowHeight(20);
        jScrollPane2.setViewportView(tblPatientPlan);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            PatientPlan dialog = new PatientPlan(ID, new javax.swing.JFrame(), true);
    ...
    public javax.swing.JTable tblPatientPlan;
